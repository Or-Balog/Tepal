...
Tepal is a beta for Apple-silicon Macs running macOS 26 or later. Releases are signed with a Developer ID and notarized by Apple.
...
- Calendar connection requires a Google account synced through macOS and explicit Calendar consent. A locally rebuilt copy can trigger a new consent request.
